...
const exactErrors: Partial<Record<string, TranslationKey>> = {
  ...
  "Unable to reauthenticate Codex account.": "errors.reauthenticate",
  "Unable to start Codex sign-in.": "errors.reauthenticateStart",
  "Unable to complete Codex sign-in.": "errors.reauthenticateComplete",
  "Codex sign-in was not completed successfully.": "errors.reauthenticateFailed",
  "Another Codex sign-in is already in progress.": "errors.reauthenticateBusy",
  "Codex sign-in session is no longer available.": "errors.reauthenticateSession",
  "Signed-in account does not match the selected account.":
    "errors.reauthenticateMismatch",
